...
public class IngredientOrderResource {
    ...
    @Timed
    public ResponseEntity<IngredientOrder> createIngredientOrder(@Valid @RequestBody IngredientOrder ingredientOrder) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<IngredientOrder> updateIngredientOrder(@Valid @RequestBody IngredientOrder ingredientOrder) throws URISyntaxException {
