...
public class RestaurantWorkerResource {
    ...
    @Timed
    public ResponseEntity<RestaurantWorker> createRestaurantWorker(@Valid @RequestBody RestaurantWorker restaurantWorker) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<RestaurantWorker> updateRestaurantWorker(@Valid @RequestBody RestaurantWorker restaurantWorker) throws URISyntaxException {
    ...
    @Timed
    public List<RestaurantWorker> getAllRestaurantWorkers(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all RestaurantWorkers");
        return restaurantWorkerRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<RestaurantWorker> getRestaurantWorker(@PathVariable Long id) {
        ...
        Optional<RestaurantWorker> restaurantWorker = restaurantWorkerRepository.findOneWithEagerRelationships(id);
