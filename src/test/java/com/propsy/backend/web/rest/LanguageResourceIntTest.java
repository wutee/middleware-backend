...
import com.propsy.backend.repository.LanguageRepository;
...
public class LanguageResourceIntTest {
    ...
    public void createLanguage() throws Exception {
        ...
        assertThat(testLanguage.getNameSlug()).isEqualTo(DEFAULT_NAME_SLUG);
    }
    ...
    public void updateLanguage() throws Exception {
        ...
        Language testLanguage = languageList.get(languageList.size() - 1);
        assertThat(testLanguage.getNameSlug()).isEqualTo(UPDATED_NAME_SLUG);
    }
