...
import { IIngredientOrder, IngredientOrder } from 'app/shared/model/ingredient-order.model';
...
describe('Service Tests', () => {
    describe('IngredientOrder Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(IngredientOrderService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new IngredientOrder(0, currentDate, 0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a IngredientOrder', async () => {
                ...
                service
                    .create(new IngredientOrder(null))
                    .pipe(take(1))
