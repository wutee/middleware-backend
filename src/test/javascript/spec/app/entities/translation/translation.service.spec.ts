...
import { ITranslation, Translation } from 'app/shared/model/translation.model';
...
describe('Service Tests', () => {
    describe('Translation Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Translation(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Translation', async () => {
                const returnedFromService = Object.assign(
                    {
                        translation: 'BBBBBB'
                    },
